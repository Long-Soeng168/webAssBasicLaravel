          ...
          <form action="{{ url('admin/slides/' . $slide->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                <div>
                    ...
                    <input value="{{ $slide->name }}" type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="">
                </div>
                <div>
            ...
            <div class="flex justify-end gap-2">
              ...
              <button class="px-8 py-2 bg-black hover:bg-white hover:text-black border-2 border-black text-white">Update Slide</button>
            </div>
        </form>
      </div>
    </section>
