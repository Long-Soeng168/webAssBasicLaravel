...
<div class="p-4">
  <div class=" pb-2 mb-2 flex justify-between items-center">
    ...
    <a href="{{ url('admin/categories/create') }}" class="px-8 py-2 bg-black text-white">Add Slide</a>
  </div>
                      ...
                      <tbody>
                          @foreach ($categories as $slide)
                            <tr class="border-b dark:border-gray-700">
                              ...
                              <td class="px-4 py-3">
                                <img class="w-10 aspect-square object-contain" src="{{ asset('images/categories/'. $slide->image) }}" alt="user photo">
                              </td>
                              <td class="px-4 py-3">
                                <div class="flex gap-2 h-full items-center justify-center">
                                  ...
                                  <a href="{{ url('admin/categories/'.$slide->id.'/edit') }}" class="text-blue-700">
                                  ...
                                  <a href="{{ url('admin/categories/'.$slide->id.'/delete') }}" class="text-red-700">
